    ...
    <form action="" method="">
        ...
        <div id="data">
            <table id="datalist">
                ...
                <tr>
                    <td><a href="service_detail" title="查看明细">1</a></td>
                    <td>101</td>
                    ...
                    <td class="td_modi">
                        ...
                        <input type="button" value="修改" class="btn_modify" onclick="location.href='service_modi';" />
                        <input type="button" value="删除" class="btn_delete" onclick="deleteAccount();" />
                    </td>
                </tr>
                <tr>
                    <td><a href="service_detail" title="查看明细">2</a></td>
                    <td>101</td>
                    <td>230102197902137862</td>
                    <td>张三</td>
                    <td>openlab2</td>
                ...
                <tr>
                    <td><a href="service_detail" title="查看明细">3</a></td>
                    <td>101</td>
                    <td>230102197902137862</td>
                    <td>张三</td>
                    <td>openlab3</td>
                ...
                <tr>
                    <td><a href="service_detail" title="查看明细">4</a></td>
                    <td>102</td>
                ...
                <tr>
                    <td><a href="service_detail" title="查看明细">5</a></td>
                    <td>102</td>
                    <td>230102197902137862</td>
                    <td>张三</td>
                    <td>openlab1</td>
